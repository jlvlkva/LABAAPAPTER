...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("IncomeDataAdapter(Contact, Customer)");
    ...
    public static void customerTest(Customer customer) {
        ...
        System.out.println("CountryName: " + customer.getCountryName());
    ...
    public static void incomeDataTest(IncomeData incomeData){
        ...
        System.out.println("ContactFirst name: "+incomeData.getContactFirstName());
